...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [coffeeCup];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/calling.svg
  SvgGenImage get calling => const SvgGenImage('assets/svg/calling.svg');
...
class Assets {
  ...
  static const String package = 'coffee_shop_ex';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/coffee_shop_ex/$_assetName';
}
